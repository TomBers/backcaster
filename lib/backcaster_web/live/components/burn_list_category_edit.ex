defmodule BurnListCategoryEdit do
  ...
  def render(assigns) do
    ...
    <span class="emphasis">
      ...
      {#else}
        <div>{@category.text} <div data-tip="Edit list name" class="tooltip tooltip-bottom"><button class="btn btn-ghost btn-xs" :on-click="edit">
          ...
          <div data-tip="Delete list" class="tooltip tooltip-bottom">
            <button class="btn btn-ghost btn-xs" :on-click={@delete_item} value={@id}>
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </button></div>
          <div data-tip="Webhook endpoint" class="tooltip tooltip-bottom">
